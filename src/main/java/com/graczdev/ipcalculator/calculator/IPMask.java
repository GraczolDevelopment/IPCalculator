...
public enum IPMask {
    ...
    MASK_0(0),   MASK_1(1),   MASK_2(2),   MASK_3(3),   MASK_4(4),
    MASK_5(5),   MASK_6(6),   MASK_7(7),   MASK_8(8),   MASK_9(9),
    ...
    IPMask(int cidr) {
        String addressBinary = Bit.ONE.repeat(cidr) + Bit.ZERO.repeat(32 - cidr);
